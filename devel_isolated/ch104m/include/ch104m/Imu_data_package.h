// Generated by gencpp from file ch104m/Imu_data_package.msg
// DO NOT EDIT!


#ifndef CH104M_MESSAGE_IMU_DATA_PACKAGE_H
#define CH104M_MESSAGE_IMU_DATA_PACKAGE_H
...
struct Imu_data_package_
{
  ...
  typedef boost::shared_ptr< ::ch104m::Imu_data_package_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ch104m::Imu_data_package_<ContainerAllocator> const> ConstPtr;

}; // struct Imu_data_package_

typedef ::ch104m::Imu_data_package_<std::allocator<void> > Imu_data_package;

typedef boost::shared_ptr< ::ch104m::Imu_data_package > Imu_data_packagePtr;
typedef boost::shared_ptr< ::ch104m::Imu_data_package const> Imu_data_packageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ch104m::Imu_data_package_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ch104m::Imu_data_package_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ch104m::Imu_data_package_<ContainerAllocator1> & lhs, const ::ch104m::Imu_data_package_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ch104m::Imu_data_package_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ch104m::Imu_data_package_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ch104m::Imu_data_package_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ch104m::Imu_data_package_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ch104m::Imu_data_package_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ch104m::Imu_data_package_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ch104m::Imu_data_package_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ch104m::Imu_data_package_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x282c5be5a2e43c66ULL;
  static const uint64_t static_value2 = 0x8a2bbf282a34b55aULL;
};

template<class ContainerAllocator>
struct DataType< ::ch104m::Imu_data_package_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ch104m::Imu_data_package_<ContainerAllocator> >
{
  static const char* value()
  {
    return "uint8 tag\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ch104m::Imu_data_package_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ch104m::Imu_data_package_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ch104m::Imu_data_package_<ContainerAllocator>& v)
  {
    s << indent << "tag: ";
...
#endif // CH104M_MESSAGE_IMU_DATA_PACKAGE_H
