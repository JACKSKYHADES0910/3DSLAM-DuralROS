...
if("TRUE" STREQUAL "TRUE")
  set(wr_fslidar_SOURCE_PREFIX /home/xyz/autolabor/src/driver/lidar/wr_fslidar)
  set(wr_fslidar_DEVEL_PREFIX /home/xyz/autolabor/devel_isolated/wr_fslidar)
  ...
  set(wr_fslidar_INSTALL_PREFIX /home/xyz/autolabor/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'wr_fslidar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xyz/autolabor/src/driver/lidar/wr_fslidar/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(wr_fslidar_EXPORTED_TARGETS ${${wr_fslidar_dep}_EXPORTED_TARGETS})
endforeach()
