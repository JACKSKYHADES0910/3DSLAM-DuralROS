...
void autolabor_plugin::PathRvizPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PathRvizPlugin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject autolabor_plugin::PathRvizPlugin::staticMetaObject = { {
    &rviz::Panel::staticMetaObject,
    qt_meta_stringdata_autolabor_plugin__PathRvizPlugin.data,
    qt_meta_data_autolabor_plugin__PathRvizPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
