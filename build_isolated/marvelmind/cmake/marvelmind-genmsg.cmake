...
set(MSG_I_FLAGS "-Imarvelmind:/home/xyz/autolabor/src/driver/location/marvelmind/msg")
...
get_filename_component(_filename "/home/xyz/autolabor/src/driver/location/marvelmind/msg/beacon_pos.msg" NAME_WE)
add_custom_target(_marvelmind_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "marvelmind" "/home/xyz/autolabor/src/driver/location/marvelmind/msg/beacon_pos.msg" ""
)
...
_generate_msg_cpp(marvelmind
  "/home/xyz/autolabor/src/driver/location/marvelmind/msg/beacon_pos.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/marvelmind)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/marvelmind\")")
  # install generated code
  install(
