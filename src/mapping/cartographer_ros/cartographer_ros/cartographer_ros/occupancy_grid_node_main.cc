...
DEFINE_bool(unknow_as_free, false,
            "Unknown areas on the map are treated as drivable areas.");
...
void Node::DrawAndPublish(const ::ros::WallTimerEvent& unused_timer_event) {
  ...
  std::unique_ptr<nav_msgs::OccupancyGrid> msg_ptr = CreateOccupancyGridMsg(
      painted_slices, resolution_, last_frame_id_, last_timestamp_, FLAGS_unknow_as_free);
