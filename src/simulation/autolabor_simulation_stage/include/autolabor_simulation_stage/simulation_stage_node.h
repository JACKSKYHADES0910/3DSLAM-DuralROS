...
private:
  ...
  bool mapHandleServer(autolabor_simulation_stage::ObstacleMap::Request &req, autolabor_simulation_stage::ObstacleMap::Response &res);
  ...
  char calValue(int index, char* obs_map);
